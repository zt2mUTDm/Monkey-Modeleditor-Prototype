...
public final class MaxSuspensionTravelCmEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public MaxSuspensionTravelCmEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getMaxSuspensionTravelCm());
			}
			@Override
			public void set(final Float newValue) {
				parent.setMaxSuspensionTravelCm(newValue);
			}
		};
	}
	...
	public String getName() {
		return("Max suspension travel CM");
	}
