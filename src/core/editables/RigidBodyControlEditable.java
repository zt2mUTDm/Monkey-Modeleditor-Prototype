...
public final class RigidBodyControlEditable extends PhysicsControlEditable {
	private final RigidBodyControl storageControl;
	
	public RigidBodyControlEditable(final RigidBodyControl control, final CollisionShapeEditable shape) {
	...
	@Override
	public RigidBodyControl createControl() {
		final RigidBodyControl control = copyControl(storageControl);
		control.setCollisionShape((ConvexShape) getShape().createShape());
		control.setSpatial(null);
		return(control);
	}
	
	private RigidBodyControl copyControl(final RigidBodyControl control) {
		return(new Cloner().clone(control));
	}
	
	public static RigidBodyControlEditable valuesOf(final RigidBodyControl control) {
		...
		return(new RigidBodyControlEditable(control, shape));
	}
