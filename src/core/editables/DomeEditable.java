...
public final class DomeEditable implements Editable, HasColor, HasPlanes, HasRadialSamples, HasRadius {
	...
	private int planes = 16;
	private int radialSamples = 8;
	private float radius = 1f;
	
	private ColorRGBA color;
	
	public DomeEditable(final SimpleApplication app, final String name) {
	...
	public DomeEditable(final SimpleApplication app, final Geometry geometry) {
		this.app = Requires.notNull(app, "app == null");
		
		final Dome mesh = (Dome) geometry.getMesh();
