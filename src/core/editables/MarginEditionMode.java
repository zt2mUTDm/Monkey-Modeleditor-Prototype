...
public final class MarginEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public MarginEditionMode(final CollisionShapeEditable shape) {
		Requires.notNull(shape, "parent == null");
