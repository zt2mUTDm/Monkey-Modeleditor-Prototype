...
public final class ContactStiffnessEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public ContactStiffnessEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getContactStiffness());
			}
			@Override
			public void set(final Float newValue) {
				parent.setContactStiffness(newValue);
			}
		};
	}
	public ContactStiffnessEditionMode(final RigidBodyControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public ContactStiffnessEditionMode(final CharacterControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public ContactStiffnessEditionMode(final GhostControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
