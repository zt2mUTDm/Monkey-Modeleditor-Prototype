...
public final class RollingFrictionEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public RollingFrictionEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getRollingFriction());
			}
			@Override
			public void set(final Float newValue) {
				parent.setRollingFriction(newValue);
			}
		};
	}
	public RollingFrictionEditionMode(final RigidBodyControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public RollingFrictionEditionMode(final CharacterControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public RollingFrictionEditionMode(final GhostControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
