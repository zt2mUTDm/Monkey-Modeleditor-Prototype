...
public final class CcdSweptSphereRadiusEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public CcdSweptSphereRadiusEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getCcdSweptSphereRadius());
			}
			@Override
			public void set(final Float newValue) {
				parent.setCcdSweptSphereRadius(newValue);
			}
		};
	}
	public CcdSweptSphereRadiusEditionMode(final RigidBodyControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public CcdSweptSphereRadiusEditionMode(final CharacterControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public CcdSweptSphereRadiusEditionMode(final GhostControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public String getName() {
		return("CCD swept sphere radius");
	}
