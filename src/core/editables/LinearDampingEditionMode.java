...
public final class LinearDampingEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public LinearDampingEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getLinearDamping());
			}
			@Override
			public void set(final Float newValue) {
				parent.setLinearDamping(newValue);
			}
		};
	}
	public LinearDampingEditionMode(final RigidBodyControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public LinearDampingEditionMode(final CharacterControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
