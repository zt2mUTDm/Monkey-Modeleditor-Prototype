...
public final class SuspensionDampingEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public SuspensionDampingEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getSuspensionDamping());
			}
			@Override
			public void set(final Float newValue) {
				parent.setSuspensionDamping(newValue);
			}
		};
	}
