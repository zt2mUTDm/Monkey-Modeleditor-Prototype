...
public final class SpinningFrictionEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public SpinningFrictionEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getSpinningFriction());
			}
			@Override
			public void set(final Float newValue) {
				parent.setSpinningFriction(newValue);
			}
		};
	}
	public SpinningFrictionEditionMode(final RigidBodyControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public SpinningFrictionEditionMode(final CharacterControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public SpinningFrictionEditionMode(final GhostControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
