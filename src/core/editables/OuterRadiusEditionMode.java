...
public final class OuterRadiusEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public OuterRadiusEditionMode(final TorusMeshEditable parent) {
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getOuterRadius());
			}
			@Override
			public void set(final Float newValue) {
				parent.setOuterRadius(newValue.floatValue());
			}
		};
	}
