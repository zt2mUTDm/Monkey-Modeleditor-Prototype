...
public final class RadialSamplesEditionMode implements EditionMode {
	private final ValueIo<Integer> io;
	
	public RadialSamplesEditionMode(final CylinderMeshEditable parent) {
		io = new ValueIo<Integer>() {
			@Override
			public Integer get() {
				return(parent.getRadialSamples());
			}
			@Override
			public void set(final Integer newValue) {
				parent.setRadialSamples(newValue.intValue());
			}
		};
	}
	public RadialSamplesEditionMode(final SphereMeshEditable parent) {
		io = new ValueIo<Integer>() {
			@Override
			public Integer get() {
				return(parent.getRadialSamples());
	...
	public RadialSamplesEditionMode(final DomeMeshEditable parent) {
		io = new ValueIo<Integer>() {
			@Override
			public Integer get() {
				return(parent.getRadialSamples());
	...
	public RadialSamplesEditionMode(final TorusMeshEditable parent) {
		io = new ValueIo<Integer>() {
			@Override
			public Integer get() {
				return(parent.getRadialSamples());
