...
public final class SuspensionStiffnessEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public SuspensionStiffnessEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getSuspensionStiffness());
			}
			@Override
			public void set(final Float newValue) {
				parent.setSuspensionStiffness(newValue);
			}
		};
	}
