...
public final class ContactProcessingThresholdEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public ContactProcessingThresholdEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getContactProcessingThreshold());
			}
			@Override
			public void set(final Float newValue) {
				parent.setContactProcessingThreshold(newValue);
			}
		};
	}
	public ContactProcessingThresholdEditionMode(final RigidBodyControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public ContactProcessingThresholdEditionMode(final CharacterControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public ContactProcessingThresholdEditionMode(final GhostControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
