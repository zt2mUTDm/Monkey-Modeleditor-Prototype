...
public final class LinearSleepingThresholdEditionMode implements EditionMode {
	private final ValueIo<Float> io;
	
	public LinearSleepingThresholdEditionMode(final VehicleControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
				return(parent.getLinearSleepingThreshold());
			}
			@Override
			public void set(final Float newValue) {
				parent.setLinearSleepingThreshold(newValue);
			}
		};
	}
	public LinearSleepingThresholdEditionMode(final RigidBodyControlEditable parent) {
		Requires.notNull(parent, "parent == null");
		io = new ValueIo<Float>() {
			@Override
			public Float get() {
	...
	public String getName() {
		return("Linear sleeping threshold");
	}
