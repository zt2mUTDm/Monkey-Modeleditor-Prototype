...
public final class AxisSamplesEditionMode implements EditionMode {
	private final ValueIo<Integer> io;
	
	public AxisSamplesEditionMode(final CylinderMeshEditable parent) {
		io = new ValueIo<Integer>() {
			@Override
			public Integer get() {
				return(parent.getAxisSamples());
			}
			@Override
			public void set(final Integer newValue) {
				parent.setAxisSamples(newValue.intValue());
			}
		};
	}
