...
public final class UiElementsStruct {
	...
	private final DefaultTreeModel sceneGraphTreeModel = new DefaultTreeModel(null);
	private final JTree sceneGraphTree = new JTree(sceneGraphTreeModel);
	...
	private final DirectoryTree filesTree = new DirectoryTree();
	...
	private void setupPropertiesWindow() {
		...
		propertiesTable.setDefaultRenderer(Vector2f.class, new Vector2fTableRenderer());
		propertiesTable.setDefaultEditor(Vector2f.class, new Vector2fTableEditor());
		propertiesTable.setDefaultRenderer(Vec3d.class, new Vec3dTableRenderer());
		propertiesTable.setDefaultEditor(Vec3d.class, new Vec3dTableEditor());
		...
		propertiesTable.setDefaultRenderer(Quatd.class, new QuatdTableRenderer());
		propertiesTable.setDefaultEditor(Quatd.class, new QuatdTableEditor());
		
		propertiesTable.setDefaultEditor(Enum.class, new EnumTableEditor());
	...
	public DefaultTreeModel getSceneGraphTreeModel() {
		return (sceneGraphTreeModel);
	}
	...
	public DirectoryTree getFilesTree() {
		return (filesTree);
	}
